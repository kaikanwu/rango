import os
os.environ.setdefault('DJANGO_SETTING_MOUDLE', 'tango_with_django_project.setting')
...
def populate():
    # create lists contain the pages
    #
    ...
    cats = {"Python": {"pages": python_pages},
            ...
            "Django": {"pages": django_pages}, "Other Frameworks": {"pages": other_pages}
    }
...
if __name__ == '__main__' :
    print("Staring Rango population script here...")
    populate()
